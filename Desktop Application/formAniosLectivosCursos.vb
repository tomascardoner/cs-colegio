...
#Region "Load and Set Data"
    Friend Sub RefreshData(Optional ByVal PositionIDAnioLectivoCurso As Short = 0, Optional ByVal RestoreCurrentPosition As Boolean = False)
        ...
        Catch ex As Exception
            ...
            CS_Error.ProcessError(ex, "Error al leer los Cursos de los Años Lectivos.")
...
#Region "Main Toolbar"
        ...
        Else
            If Permisos.VerificarPermiso(Permisos.ANIOLECTIVOCURSO_EDITAR) Then
                ...
                Using dbContext = New CSColegioContext(True)
                    ...
                    formAnioLectivoCurso.LoadAndShow(True, Me, CType(datagridviewMain.SelectedRows(0).DataBoundItem, GridRowData).IDAnioLectivoCurso)
                End Using
            ...
            If Permisos.VerificarPermiso(Permisos.ANIOLECTIVOCURSO_ELIMINAR) Then
                ...
                Using dbContext = New CSColegioContext(True)
                    ...
                    If MsgBox(Mensaje, CType(MsgBoxStyle.Exclamation + MsgBoxStyle.YesNo, MsgBoxStyle), My.Application.Info.Title) = MsgBoxResult.Yes Then
                        ...
                        Catch ex As Exception
                            CS_Error.ProcessError(ex, "Error al eliminar el Curso del Año Lectivo.")
                        End Try
    ...
    Private Sub Ver() Handles datagridviewMain.DoubleClick
        ...
        Else
            ...
            formAnioLectivoCurso.LoadAndShow(False, Me, CType(datagridviewMain.SelectedRows(0).DataBoundItem, GridRowData).IDAnioLectivoCurso)
