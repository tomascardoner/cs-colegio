...
#Region "Definición de constantes"
    ...
    Friend Const ENTIDAD_EMPLEADO As String = "ENTIDAD_EMPLEADO"
    Friend Const ENTIDAD_EMPLEADO_ANTIGUEDAD_AGREGAR As String = "ENTIDAD_EMPLEADO_ANTIGUEDAD_AGREGAR"
    Friend Const ENTIDAD_EMPLEADO_ANTIGUEDAD_EDITAR As String = "ENTIDAD_EMPLEADO_ANTIGUEDAD_EDITAR"
    Friend Const ENTIDAD_EMPLEADO_ANTIGUEDAD_ELIMINAR As String = "ENTIDAD_EMPLEADO_ANTIGUEDAD_ELIMINAR"
    ...
    Friend Const SUELDO_LIQUIDACION_ENTIDAD_IMPRIMIR As String = "SUELDO_LIQUIDACION_ENTIDAD_IMPRIMIR"
...
#Region "Asignación de permisos"
    ...
    Friend Sub CargarArbolDePermisos(ByRef Arbol As TreeView, ByVal IDUsuarioGrupo As Byte)
        ...
        nodeCurrent = AgregarNodos(Arbol, nodeRoot, ENTIDAD_EMPLEADO, "Entidades - datos de empleados y antigüedad", ENTIDAD_EMPLEADO_ANTIGUEDAD_AGREGAR, DESCRIPCION_AGREGAR, ENTIDAD_EMPLEADO_ANTIGUEDAD_EDITAR, DESCRIPCION_EDITAR, ENTIDAD_EMPLEADO_ANTIGUEDAD_ELIMINAR, DESCRIPCION_ELIMINAR)
        ...
        nodeRoot.Nodes.Add(SUELDO_LIQUIDACION_ENTIDAD_IMPRIMIR, "Imprimir")
