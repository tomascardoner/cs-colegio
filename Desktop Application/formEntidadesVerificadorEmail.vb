...
#Region "Controls behavior"
    Private Sub BuscarEnOutlook() Handles buttonBuscarEnOutlook.Click
        If datetimepickerOutlookFechaDesde.Value > Date.Today Then
            ...
            Exit Sub
        End If
        If datetimepickerOutlookFechaHasta.Value > Date.Today Then
            ...
            Exit Sub
        End If
        If datetimepickerOutlookFechaDesde.Value > datetimepickerOutlookFechaHasta.Value Then
